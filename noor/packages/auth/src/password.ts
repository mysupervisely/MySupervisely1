...
// bcrypt is used here for dev-friendly, dependency-light password hashing
// (no native build toolchain required). docs/noor/ARCHITECTURE.md §J notes
// argon2id as the preferred algorithm before real clinical/production use —
// see docs/noor/M1-IMPLEMENTATION.md "Known limitations" for that tradeoff.
