  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      await apiFetch("/auth/login", {
        method: "POST",
        body: JSON.stringify({ email, password, app: "clinician" }),
      });
  ...
  return (
    <main className="noor-shell">
      ...
      <p className="noor-muted">
        Clinician accounts are provisioned by Noor, not self-service signup — see
        docs/noor/M1-IMPLEMENTATION.md for the dev seed account.
      </p>
